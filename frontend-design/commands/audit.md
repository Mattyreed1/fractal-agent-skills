...
- **Suggested command**: Which command to use (prefer: /audit, /critique, /polish, /distill, /harden, /optimize, /animate, /colorize, /typeset, /arrange, /extract, /adapt, /delight, /bolder, /quieter, /clarify, /onboard, /normalize, /overdrive — or other installed skills you're sure exist)
...
Map issues to available commands. Prefer these: /audit, /critique, /polish, /distill, /harden, /optimize, /animate, /colorize, /typeset, /arrange, /extract, /adapt, /delight, /bolder, /quieter, /clarify, /onboard, /normalize, /overdrive. You may also suggest other installed skills you're sure exist, but never invent commands.
