...
def setup_ssl_certificates():
    """Configure SSL certificates for macOS Python installations.

    Fixes the common SSL: CERTIFICATE_VERIFY_FAILED error on macOS when
    using standalone Python installations that don't have certs configured.
    """
    ...
    # Fallback: try common macOS cert locations
    cert_locations = [
...
# Run SSL setup on module import
