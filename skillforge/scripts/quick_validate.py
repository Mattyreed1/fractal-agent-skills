...
def validate_skill(skill_path):
    ...
    # Agent Skills open standard: name, description, license, allowed-tools, metadata,
    # version, compatibility. Claude Code extensions (code.claude.com/docs/en/skills
    # frontmatter reference): when_to_use, argument-hint, arguments,
